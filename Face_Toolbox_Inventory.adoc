...
* Not a mobile device camera, a dedicated camera device.
...
* A printer no more than 4 years old at the time of the data of testing with a DPI of at least XXXXX.
