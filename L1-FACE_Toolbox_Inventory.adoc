...
* Test user's face shall be displayed or replayed on the screen in full scale. The test user's face should be displayed as large as possible up to a 1:1 scale
...
Ideally the cylinder would be a material that can be used to tape photos to repeatedly without deforming or breaking down. This is used for consistency. Alternatives may be accceptable if they can be used consistently.

* The size of the cylinder can vary, but should be close to the size of the test user's head diamater
